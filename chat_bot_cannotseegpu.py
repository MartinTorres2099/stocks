...
embeddings_model_name = os.environ.get("Llama-2-13B-chat-GPTQ")  # Replace with your model name
# persist_directory = os.environ.get('PERSIST_DIRECTORY')  # Replace with your directory
